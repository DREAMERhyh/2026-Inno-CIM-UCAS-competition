...
7 个 $\alpha$ 点，CIFAR-100 的 \textbf{8000 样本子集}（\textbf{非全量 10\,000}）、best 权重、单种子。
...
全量口径为 59.99。因两项同口径，headroom 内部自洽；\S6 已将其记为\textbf{下界}。
全量口径的重跑列入第七阶段 M0c（CPU，因 GPU 被 M4 占用）。}；
...
架构杠杆与读出杠杆在尾部近似正交可叠加：\texttt{5$\times$MaxPool 主干 $+$ readout-NAT}
